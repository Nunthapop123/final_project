...
class Admin:
    def __init__(self, id, username, role, person_table, login_table):
        self.id = id
...
def manage_info(self):
        while True:
            ...
            if user_choice == '1':
                ...
                self.person_table.table.append({'ID': user_id, 'first': first_name, 'last': last_name, 'type': type})
                self.login_table.table.append({'ID': user_id, 'username': username, 'password': password, 'role': type})
